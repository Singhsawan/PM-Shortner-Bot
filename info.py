...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001802585439').split()]
...
# Others
VERIFY = bool(environ.get('VERIFY', Ture))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Action_Movies_Group')
